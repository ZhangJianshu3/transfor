...
if __name__ == '__main__':
    ...
    # 测试
    print and_perception.predict([890, 268])
    print and_perception.predict([835, 316])
    print and_perception.predict([772, 372])
    print and_perception.predict([698, 436])
    print and_perception.predict([614, 511])
    print and_perception.predict([515, 598])
    print and_perception.predict([398, 707])
    '''
