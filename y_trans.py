...
def get_training_dataset():
    ...
    labelpath = '/home/zjs/Projects/transfor/y_coordinator'
...
if __name__ == '__main__':
    ...
    ax.plot_surface(u, v, y, rstride=5, cstride=5, cmap=cm.coolwarm, linewidth=0, antialiased=False, alpha = 0.3)
    ax.scatter(uu, vv, yy, color = 'r')
    ax.set_xlabel('u')
    ax.set_ylabel('v')
    ax.set_zlabel('y')
    plt.show()
