...
if __name__ == '__main__':
    ...
    for sample in samples:
        ...
        for linenum in range(7):
            ...
            vecspath = '/home/wlw/projects/transfor/force/linetxt2/pic_coor/line' + str(linenum+1)
            x_labelpath = '/home/wlw/projects/transfor/force/linetxt2/x_coor/x_line' + str(linenum+1)
            y_labelpath = '/home/wlw/projects/transfor/force/linetxt2/y_coor/y_line' + str(linenum+1)
        ...
        txt_path = '/home/wlw/projects/transfor/force_result/reverse/28_in_56.txt'
    ...
    final_data = str(min_seq) + ' ' + str(min_ave) + ' ' + \
                 str(w1) + ' ' + str(w2) + ' ' + str(b1) + ' ' + \
                 str(w3) + ' ' + str(w4) + ' ' + str(b2)
    final_txt_path = '/home/wlw/projects/transfor/force_result/reverse/final_28_in_56.txt'
